		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php  
							$query = $conn->query("SELECT * FROM `manager`") or die(mysqli_error("$conn"));
						...
						<tr>
							...
							<td><a class = "btn btn-warning" href = "edit_account.php?manager_id=<?php echo $fetch['manager_id']?>"><i class = "glyphicon glyphicon-edit"></i> Edit</a> <a class = "btn btn-danger" onclick = "confirmationDelete(this); return false;" href = "delete_account.php?manager_id=<?php echo $fetch['manager_id']?>"><i class = "glyphicon glyphicon-remove"></i> Delete</a></center></td>
						</tr>
						<?php
							}
						?>
