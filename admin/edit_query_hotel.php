...
if (isset($_POST['edit_hotel'])) {
	...
	$conn->query("UPDATE `hotel` SET `hotel_name` = '$hotel_name', `capacity` = '$capacity','hotel_location'='$hotel_location', `photo` = '$photo_new_name' WHERE `hotel_id` = '$_REQUEST[hotel_id]'") or die(mysqli_error($conn));
